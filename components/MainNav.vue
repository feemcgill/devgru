  ...
  <nav :class="!floating && 'not-floating'" v-on:keyup.esc="closeMenu">
      ...
      <button tabindex="1" @click="handleBurgerClick" id="burg">
        <div v-if="!floating" class="burg">
          <svg width="46" height="22" viewBox="0 0 46 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            <line x1="0.0810852" y1="21.2132" x2="45.2443" y2="21.2132" stroke="black" />
            <line x1="0.0810852" y1="11.2132" x2="45.2443" y2="11.2132" stroke="black" />
            <line x1="0.0810852" y1="1.2132" x2="45.2443" y2="1.2132" stroke="black" />
          </svg>
        </div>
        <div class="x" v-else>
          <svg width="33" height="34" viewBox="0 0 33 34" fill="none" xmlns="http://www.w3.org/2000/svg">
            <line x1="0.547889" y1="0.39962" x2="32.4831" y2="32.3348" stroke="black" />
            <line x1="32.4831" y1="1.10673" x2="0.547879" y2="33.0419" stroke="black" />
          </svg>
        </div>
      </button>
    </div>
    <ul :class="isHome && 'homepage'" :v-bind="isHome && getMousePos">
      <li @click="closeMenu" class="home" v-if="!isHome">
        <nuxt-link to="/" :tabindex="isHome || floating ? 0 : -1" :tabindex="isHome || floating ? 0 : -1">
          <svg width="84" height="72" viewBox="0 0 84 72" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M1.72476 71.0002V22.6243L42.2575 1.50451L82.7978 22.6243V71.0002H1.72476Z" stroke="#231F20"
      ...
      <li @click="closeMenu" class="mint">
        <a>
          <svg width="88" height="76" viewBox="0 0 88 76" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M3.09863 73.8604L43.8018 3.36036L84.505 73.8604H3.09863Z" stroke="black" stroke-width="3" />
          </svg>

          <div><span>Mint our NFT!</span></div>
        </a>
      </li>
      <li @click="closeMenu" class="check" :style="
        isHome &&
        mouseAnimsEnabled &&
        `transform: translate(calc(35vw + ${getMousePos.x / 100
        }px), calc(-25vh + ${getMousePos.y / 100
        }px));  transition-timing-function: ease-out; transition-duration: 1s;`
      ">
        <nuxt-link to="/portfolio" :tabindex="isHome || floating ? 0 : -1" :tabindex="isHome || floating ? 0 : -1">
      ...
      <li @click="closeMenu" class="contact" :style="
        isHome &&
        mouseAnimsEnabled &&
        `transform: translate(calc(25vw + ${getMousePos.x / -100
        }px), calc(-2vh + ${getMousePos.y / -100
        }px));  transition-timing-function: ease-out; transition-duration: 0.2s;`
      ">
        <nuxt-link to="/contact" :tabindex="isHome || floating ? 0 : -1" :tabindex="isHome || floating ? 0 : -1">
      ...
      <li @click="closeMenu" class="play" :style="
        isHome &&
        mouseAnimsEnabled &&
        `transform: translate(calc(5vw + ${getMousePos.x / 100
        }px), calc(-50vh + ${getMousePos.y / -100
        }px));  transition-timing-function: ease-out;`
      ">
        <nuxt-link to="/game" :tabindex="isHome || floating ? 0 : -1">
