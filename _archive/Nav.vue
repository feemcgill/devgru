<template>
  <div>
    <a v-bind:class="showNav ? 'nav-toggle open' : 'nav-toggle closed'" v-on:click="showNav = !showNav">
      <div class="nav-tog-wrap">
        <svg id="folder_closed" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 66.8 52.03">
          <path class="cls-1"
        ...
        <svg id="folder_opened" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 84.66 52.03">
          <path class="cls-1"
