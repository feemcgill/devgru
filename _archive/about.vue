    ...
    <section class="specialties">
      <div class="container">
        <ul class="list wha">
          ...
          <li><span>Creative Frontend</span></li>
          <li><span>Wordpress</span></li>
          <li><span>Shopify</span></li>
          <li><span>Banner Ads</span></li>
        </ul>
      </div>
    </section>
...
<style lang="scss" scoped>
  ...
  .specialties {
    ...
    mix-blend-mode: screen; */
   @include pattern-blend('~assets/patterns/cross-1.png');
    z-index: 1;
    position: relative;
    margin: 5em 0;
    .container {
  ...
  .contact {
    background: $flair;
    position: relative;
    @include pattern-blend('~assets/patterns/diag-stripe-top-right.png');
    .container {
      position: relative;
      z-index: 100;
      @include container;
