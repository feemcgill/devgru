      ...
      <h2 class="wha">
        ...
        <span class="docs icon">
          <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 275.72 285.03">
            <path class="cls-1"
              d="M243.16,256.63h-36.7v36.89H4.14V82.07h36.7V45.18H77.73V8.48H279.86V219.93h-36.7ZM197.33,91.2H13.27V284.39H197.33Zm-156.49,46v-9.12H169.57v9.12Zm0,36.7v-9.12H169.57v9.12Zm0,36.89v-9.13H169.57v9.13Zm0,36.7v-9.13H169.57v9.13ZM50,54.31V82.07H206.46V247.5H234V54.31Zm36.89-36.7V45.18h156.3V210.8h27.57V17.61Z"
              transform="translate(-4.14 -8.48)" />
          </svg>
        </span>
        Animi perferendis ullam recusandae? Impedit, consequuntur. Suscipit eveniet natus dolore pariatur sunt non
        repudiandae harum voluptatem expedita sed dignissimos nulla temporibus aut, modi sit iste amet ipsum, totam
        corporis asperiores quasi odio tempora officia. At, magni?
        <span class="star icon">
          <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 51.26 50.45">
            <path class="cls-1"
              d="M25.91,43.19,17,50.64,15,39.22H3.37l5.8-10.06L.28,21.67l10.9-4-2-11.42,10.9,4L25.91.19l5.83,10.06,10.9-4-2,11.42,10.9,4-8.9,7.49,5.8,10.06H36.84l-2,11.42Zm0-1.79A14.63,14.63,0,0,0,36.65,37a14.65,14.65,0,0,0,4.44-10.74,14.65,14.65,0,0,0-4.44-10.74A14.63,14.63,0,0,0,25.91,11a14.6,14.6,0,0,0-10.74,4.45,14.62,14.62,0,0,0-4.45,10.74A14.63,14.63,0,0,0,15.18,37,14.66,14.66,0,0,0,25.91,41.4Z"
              transform="translate(-0.28 -0.19)" />
          </svg>
        </span>
